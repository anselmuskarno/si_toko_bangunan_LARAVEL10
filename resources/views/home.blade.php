...
<head>
  ...
  <link rel="apple-touch-icon" href="pwa/assets/img/icon.png">
...
<body>
  ...
  <nav class="navbar navbar-expand-lg ">
    <div class="container" style="margin-left: 20px;">
      <a class="text-success navbar-brand" href="/user"><b> Toko Mulia Jaya</b></a>
      kategori
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a href="#!" data-bs-toggle="modal" data-bs-target="#pemberitahuanModal"> <img src="user/img/keranjangFix.png" style="width: 20px;" alt="" srcset=""></a> &nbsp;&nbsp; |
        &nbsp;&nbsp;

        <form class="d-flex" style="margin-right: -70px;">
          <button class="btn btn-sm btn-outline-success" data-bs-toggle="modal" data-bs-target="#loginModal" type="button">
            <b> Masuk</b>
          </button> &nbsp;
          <button class="btn btn-sm btn-success " type="button" data-bs-toggle="modal" data-bs-target="#daftarModal">
            <b> Daftar</b>
          </button>
        </form>
        <!-- Modal Login -->
        ...
        <div class="col-sm-2 mb-5">
          ...
          <div class="card h-100 " style="font-size: 13px;">
            ...
            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
              <div class="" data-bs-toggle="modal" data-bs-target="#pemberitahuanModal"><a class="btn btn-sm btn-outline-success mt-auto"> Beli</a> <a class="btn btn-sm btn-success mt-auto" href="#!">+keranjang</a>
                <!-- Modal pemberitahuan -->
                <div class="modal fade" id="pemberitahuanModal" tabindex="-1" aria-labelledby="pemberitahuanModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="pemberitahuanModalLabel">Konfirmasi</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <div class="modal-body">
                        <div class="container">
                          <h5> Anda harus LOGIN terlebih dahulu untuk membeli barang!</h5>
                        </div>
                        <div class="modal-footer">
                          <button type="button" class="btn btn-success" data-bs-dismiss="modal">OK. Saya Mengerti</button>
                        </div>
