  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body" style="background-color:white">
                  <h4 class="card-title text-dark">Daftar Keranjang</h4>
                  </p>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td> {{ $k->nama_barang }} </td>
                          <td>
                            <a class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editModal{{ $k->id }}"> <i class="mdi mdi-table-edit"></i>Edit</a>
                            <a href="/hapusKeranjang/{{$k->id}}" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin data ini akan dihapus?');"> <i class="mdi mdi-delete-forever"></i> Hapus</a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
        ...
        <!-- Modal Edit -->
        @foreach ($keranjang as $k)
        <div class="modal fade bg-warning" id="editModal{{ $k->id }}" tabindex="-1" aria-labelledby="DaftarModalLabel" aria-hidden="true">
          <div class="modal-dialog ">
            <div class="modal-content ">
              ...
              <div class="modal-body">
                <div class="container">
                  <form action="/editKeranjang/{{ $k->id }}" method="post">
                    @csrf
                    <div class="mb-3">
                      <label for="nama" class="form-label">Nama Pembeli</label>
                      <Select class="form-control text-white" name="nama_pembeli">
                        <option value="{{ $k->nama_pembeli }}">{{ $k->nama_pembeli }}</option>
                        @foreach ($user as $u)
                    ...
                    <div class="mb-3">
                      ...
                      <Select class="form-control text-white" name="nama_barang">
