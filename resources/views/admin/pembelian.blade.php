  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body" style="background-color:white">
                  <h4 class=" card-title text-dark">Daftar Pembelian</h4>
                  </p>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#detailModal{{ $p->id }}"> <i class="mdi mdi-eye"></i>Detail</a>
                            <a href="/ubahStatus/{{$p->id}}" class="btn btn-sm btn-warning"> <i class="mdi mdi-table-edit"></i>Ubah Status</a>
                            <a href="/hapusPembelian/{{$p->id}}" onclick="return confirm('Apakah anda yakin data ini akan dihapus?');" class="btn btn-sm btn-danger"> <i class="mdi mdi-delete-forever"></i> Hapus</a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
        ...
        <!-- Modal -->
        @foreach ($pembelian as $p)
        <div class="modal fade bg-warning" id="detailModal{{ $p->id }}" tabindex="-1" aria-labelledby="tambahModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="tambahModalLabel">Detail Data</h5>
                ...
                <div class="container">
                  <form action="" method="post">
                    <?php if ($p->bukti_pembayaran == null) { ?>
                      <div class="badge bg-danger">Bukti Pembayaran Belum diupload</div>
                    <?php  } else { ?>
                      <label for="nama_barang" class="form-label">Gambar Bukti Pembayaran</label>
                      <img src="storage/{{ $p->bukti_pembayaran }}" style="width: 300px;" alt="">
                    <?php } ?>
                    <div class="mb-3">
                      <label for="nama_barang" class="form-label">Nama Barang</label>
                      <input type="text" name="nama_barang" value="{{ $p->nama_barang }}" class="form-control text-dark" id="nama_barang" readonly>
                    </div>
                    <div class="mb-3">
                      <label for="total_bayar" class="form-label">Total Bayar</label>
                      <input type="text" name="total_bayar" value="{{ $p->total_bayar }}" class="form-control text-dark" id="total_bayar" readonly>
                    </div>
                    <div class="mb-3">
                      <label for="status_bayar" class="form-label">Status Bayar</label>
                      <input type="text" name="status_bayar" value="{{ $p->status_bayar }}" class="form-control text-dark" id="status_bayar" readonly>
                    </div>
                    <div class="mb-3">
                      <label for="status_pengiriman" class="form-label">Status Pengiriman</label>
                      <input type="text" name="status_pengiriman" value="{{ $p->status_pengiriman }}" class="form-control text-dark" id="status_pengiriman" readonly>
                    </div>
                    <div class="mb-3">
                      <label for="tanggal_pembelian" class="form-label">Tanggal Pembelian</label>
                      <input type="text" name="tanggal_pembelian" value="{{ $p->tanggal_pembelian }}" class="form-control text-dark" id="tanggal_pembelian" readonly>
                    </div>
                    <div class="mb-3">
                      <label for="alamat_pengiriman" class="form-label">Alamat Pengiriman</label>
                      <input type="text" name="alamat_pengiriman" value="{{ $p->alamat_pengiriman }}" class="form-control text-dark" id="alamat_pengiriman" readonly>
                    </div>
                    <div class="mb-3">
                      <label for="tipe_bayaran" class="form-label">Tipe Bayaran</label>
                      <input type="text" name="tipe_bayaran" value="{{ $p->tipe_bayaran }}" class="form-control text-dark" id="tipe_bayaran" readonly>
                    </div>
                    <div class="mb-3">
                      <label for="nama_pembeli" class="form-label">Nama Pembeli</label>
                      <input type="text" name="nama_pembeli" value="{{ $p->nama_pembeli }}" class="form-control text-dark" id="nama_pembeli" readonly>
                    </div>
                    <div class="mb-3">
                      <label for="nomor_hp_pembelian" class="form-label">Nomor Hp Pembeli</label>
                      <input type="text" name="nomor_hp_pembelian" value="{{ $p->nomor_hp_pembelian }}" class="form-control text-dark" id="nomor_hp_pembelian" readonly>
                    </div>
